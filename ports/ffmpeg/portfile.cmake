...
elseif(VCPKG_TARGET_IS_UWP)
    ...
    if("none" IN_LIST FEATURES)
        string(APPEND OPTIONS " --disable-d3d11va")
    else()
        string(APPEND OPTIONS " --enable-d3d11va")
    endif()
elseif(VCPKG_TARGET_IS_WINDOWS)
    string(APPEND OPTIONS " --target-os=win32 --enable-w32threads --enable-dxva2 --enable-mediafoundation")
    if("none" IN_LIST FEATURES)
        string(APPEND OPTIONS " --disable-d3d11va")
    else()
        string(APPEND OPTIONS " --enable-d3d11va")
...
if ("none" IN_LIST FEATURES)
    set(OPTIONS "${OPTIONS} --disable-all")
endif()

if ("d3d11va" IN_LIST FEATURES)
    set(OPTIONS "${OPTIONS} --enable-d3d11va")
endif()
...
if ("decoder-adpcm-ima-qt" IN_LIST FEATURES)
    set(OPTIONS "${OPTIONS} --enable-decoder=adpcm_ima_qt")
endif()

if ("demuxer-aiff" IN_LIST FEATURES)
    set(OPTIONS "${OPTIONS} --enable-demuxer=aiff")
endif()
